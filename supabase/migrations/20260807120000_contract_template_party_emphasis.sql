...
-- =========================================================================
-- Bold the contracting parties, matching the Word originals.
--
-- Word prints "TUM.ai e.V.," and the partner name in the party block - and,
-- in the long-term contract, again above each signature - in bold. The
-- templates now carry the same emphasis through the ** markers, so the
-- preview and the PDF match the signed document.
-- =========================================================================
