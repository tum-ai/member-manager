...
-- =========================================================================
-- Closing pages as the Word originals have them.
--
-- The event contracts sign in two columns - partner on the left, TUM.ai on
-- the right - not in two stacked blocks, and every template starts its
-- annexes on a fresh page. Templates express that with:
--
--   left | right   side-by-side cells
--   ---            page break
--
-- Wording is unchanged; only the layout of the closing pages moves.
-- =========================================================================
...
{{partner_company_name}} | TUM.ai e.V.
