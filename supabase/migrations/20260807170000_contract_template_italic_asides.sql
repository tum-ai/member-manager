...
-- =========================================================================
-- Italic asides, as in the Word originals.
--
-- Word sets every "- im Folgenden ... genannt -" aside in italics, both the
-- standalone lines of the party block and the ones inside a sentence. The
-- templates now mark them with *...*.
--
