...
-- =========================================================================
-- Explicit formatting markers in the contract templates.
--
-- The renderer used to guess which paragraph was a heading (any line under 70
-- characters starting with a capital), which made plain sentences and even the
-- signature block render bold. Formatting is now declared in the template text
-- itself and Legal can adjust it in the template editor:
--
...
--   - ...   bullet list
--
-- Only the markers were added here; no wording changed.
-- =========================================================================

update "public"."contract_templates"
set "contract_text" = $contract$
# KOOPERATIONSVERTRAG
