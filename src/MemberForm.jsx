      ...
      {!isEditing ? (
        ...
        <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: '300px' }}>
            ...
            <p><strong>AGB Agreed:</strong> {sepa.agb_agreed ? 'Yes' : 'No'}</p>
          </div>
        </div>
    ...
    <form onSubmit={updateData}>
      <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: 1, minWidth: '300px' }}>
          ...
          {/* Other required personal fields */}
        ...
        <div style={{ flex: 1, minWidth: '300px' }}>
          ...
          <label style={{ display: 'block', marginBottom: '0.75rem' }}>
            <input
              ...
              disabled={loading}
            />{' '}
            Agree to SEPA mandate
          </label>
          <label style={{ display: 'block', marginBottom: '0.75rem' }}>
            <input
              type="checkbox"
              name="agb_agreed"
              checked={sepa.agb_agreed}
              onChange={handleSepaChange}
              disabled={loading || sepa.agb_agreed}
            />{' '}
            Agree to AGB*
          </label>
